...
<body>
    ...
    <section>
        <div class="container">
            <div class="main__title">Библиотека “Лабораторных работ”</div>
            <div class="main__desc">Автор: Дорохов М. Е.</div>
            <div class="buttons">
                <div class="button"><a href="/pages/labs.php">Просмотреть</a></div>
            </div>  
        </div>
    </section>
</body>
